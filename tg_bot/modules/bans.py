...
def ban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        keyboard = []
        reply = "{} ന് have been Banned by me!".format(mention_html(member.user.id, member.user.first_name))
        ...
        if excp.message == "Replied message not found":
            ...
            # Do not reply
            reply = "{} have been Banned by me !".format(mention_html(member.user.id, member.user.first_name))
